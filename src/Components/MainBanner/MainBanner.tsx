...
function MainBanner() {
  return (
    ...
    >
      <div className="text-main-text inner mx-auto w-inner-width relative">
        <div className="banner-title ml-10 max-w-[485px] w-full absolute  top-1/2 font-title text-main-title font-thin -translate-y-1/2 ">
